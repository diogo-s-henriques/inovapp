  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.header}>
        <Pressable
          onPress={() => goBack(router, '/perfil')}
          accessibilityRole="button"
          accessibilityLabel={i18n.settings.back}
          hitSlop={8}
          // Branco com contorno pelo mesmo motivo do sino da Home: sobre o fundo azulado do ecrã,
          // um círculo do mesmo tom diluía-se.
